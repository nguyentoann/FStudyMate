...
const DashboardLayout = ({ children }) => {
  ...
  const { backgroundImage, backgroundOpacity, componentOpacity, blurLevel } = useTheme();
    ...
    return (
      <>
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to={getDashboardUrl()} className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/classes" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/timetable" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/quiz" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/lessons" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
            </svg>
            Lessons
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/materials" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/student-overview" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <GlareHover {...glareProps} style={menuItemStyle}>
          <Link to="/feedback" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
            <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative">
          <GlareHover {...glareProps} style={menuItemStyle}>
            ...
            >
              ...
              <svg 
                className={`h-4 w-4 transition-transform ${openSubmenu === 'requests' ? 'transform rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
          ...
          {openSubmenu === 'requests' && (
            <div className="pl-7 mt-1 space-y-1">
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/request/move-class" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/request/join-class" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/request/regrade" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative">
          <GlareHover {...glareProps} style={menuItemStyle}>
            ...
            >
              ...
              <svg 
                className={`h-4 w-4 transition-transform ${openSubmenu === 'help' ? 'transform rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
          ...
          {openSubmenu === 'help' && (
            <div className="pl-7 mt-1 space-y-1">
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/help/faq" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  FAQ/Usage
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/help/feedback" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/help/about" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="relative">
          <GlareHover {...glareProps} style={menuItemStyle}>
            ...
            >
              ...
              <svg 
                className={`h-4 w-4 transition-transform ${openSubmenu === 'settings' ? 'transform rotate-180' : ''}`} 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor"
              >
          ...
          {openSubmenu === 'settings' && (
            <div className="pl-7 mt-1 space-y-1">
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/profile" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/account" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                  Account
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/language" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <GlareHover {...glareProps} style={menuItemStyle}>
                <Link to="/theme" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                  <svg className="w-4 h-4 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {user?.role === 'admin' && (
          <>
            <GlareHover {...glareProps} style={menuItemStyle}>
              <Link to="/admin/users" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <GlareHover {...glareProps} style={menuItemStyle}>
              <Link to="/admin/feedback" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
                <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" />
                </svg>
                Feedback Management
        ...
        {(user?.role === 'lecturer' || user?.role === 'admin') && (
          <GlareHover {...glareProps} style={menuItemStyle}>
            <Link to="/questions" className="flex items-center w-full px-3 py-2 text-sm text-gray-700 hover:bg-gray-100/20 rounded-md">
              <svg className="w-5 h-5 mr-2 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Manage Questions
    ...
    >
      <div className="flex h-screen overflow-hidden bg-gray-100 relative">
        ...
        <div className="hidden lg:flex lg:flex-shrink-0 pt-14">
          <div className="flex flex-col w-64 shadow-md" style={{
        ...
        {isMenuOpen && (
          <div className="fixed inset-0 z-[100] flex lg:hidden">
            ...
            {/* Sidebar */}
            <div className="relative flex-1 flex flex-col max-w-xs w-full mt-14 z-[101]" style={{
              backgroundColor: `rgba(255, 255, 255, ${sidebarOpacity})`,
              backdropFilter: `blur(${backdropBlurValue})`
            }}>
