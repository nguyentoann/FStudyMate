...
const BackgroundCustomizer = () => {
  const { backgroundImage, backgroundOpacity, updateBackgroundImage, updateBackgroundOpacity } = useTheme();
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden mt-6">
      <div className="p-6">
        <h3 className="text-lg font-semibold mb-4">Background Customization</h3>
        ...
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Select an image file (JPG, PNG, etc.) to use as your background. Maximum size: 5MB.
          </p>
        </div>
